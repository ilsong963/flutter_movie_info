...
void main() {
  ...
  test('test : fetchPopularMovies', () async {
    ...
    final repositoryResult = await mockMovieRepository.fetchPopularMovies();
    final useCaseResult = await fetchPopularMoviesUseCase.execute();
